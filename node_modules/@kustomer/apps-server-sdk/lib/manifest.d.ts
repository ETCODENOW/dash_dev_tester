...
import { Klass, KView, Action, Changelog, Shortcut, I18n, OWebhook, Command, SettingsManifest } from './components';
/**
 * @private
 */
export interface Manifest {
    ...
    /** The name of your app that will be displayed within Kustomer */
    installUrl?: string;
    /** The url that will be iframed for the post-install setup steps modal */
    setupUrl?: string;
