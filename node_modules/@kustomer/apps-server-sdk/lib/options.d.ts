...
export interface KAppOptions {
    ...
    /**
     * Whether or not component names should be prefixed ex `{{app_name}}--{{component_name}}`.
     * @private
     * @default true
     */
    namespace?: boolean;
    /**
     * Internationalization config for components such as triggers, actions, and settings
     */
    i18n?: I18n;
    /**
